<?php
/*  Copyright 2008-2011 Denis "Mr.Snow" Kozhukhov  (email : mrsnow@chocosnow.com), ChocoSnow.com, ChocoSnow.es
...
/*
Plugin Name: Widget Top BFG Games ES
Plugin URI: http://www.chocosnow.es/blog/widget-bfg-top-games/
Description: Este sencillo plugin es un widget que muestra una lista de Español Los juegos más populares de BigFish ES (Spanish, .es) en la barra lateral Widgetized. ENGLISH: This simple plugin is a widget that displays a ES (Spanish, .es) list of top casual games from BigFish on your widgetized sidebar.
Author: <a href="http://www.chocosnow.com/">ChocoSnow.com</a>, <a href="http://www.chocosnow.es/">ChocoSnow.es</a>, <a href="http://www.mrsnow.info/">Denis "Mr.Snow" Kozhukhov</a>
...
function widget_mrsnow_bfgtopgames_ES_work ($before, $after)
{
	$options = (array) get_option ('widget_mrsnow_bfgtopgames_ES');
	if ($options['channel']==null) 
	{
		$options['channel'] = str_replace ('.', '', str_replace ('_', '', str_replace ('-', '', $_SERVER['HTTP_HOST'])));
		update_option ('widget_mrsnow_bfgtopgames_ES', $options);
	};
	...
	$md5 = hash ("md5", $url);
	$options2 = $newoptions2 = get_option ('widget_mrsnow_bfgtopgames_ES_'.$md5);
	...
	if ($options2['csurl'] == '') 
	{
		...
		else if ($variant == 1)
		{
			...
			if ($lang=='jp') 
				...
				$newoptions2['csurl'] = $csurl[$lang].GenerateIdFromTitle_ES ($variantTitle).'/';
		...
		if ($options2 != $newoptions2) 
		{
			...
			update_option ('widget_mrsnow_bfgtopgames_ES_'.$md5, $options2);
		};
	};	
...
function GenerateIdFromTitle_ES ($title)
{
...
function widget_mrsnow_bfgtopgames_ES_control () 
{
	$text['title'] = 'Widget Título:';
	$text['titled'] = 'Top Juegos BigFish';
	$text['gnum'] = 'Número de juegos para mostrar:';
	$text['gtype'] = 'Juegos Tipo de pantalla:';
	$text['gtypep'] = 'Juegos para PC';
	//$text['gtypem'] = 'Mac Games (English sites only)';
	$text['gtypeo'] = 'Juegos en línea';
	//$text['glang'] = 'Games Language to Display:';
	$text['align'] = 'Alinear texto e imágenes:';
	$text['alignd'] = 'Tema por defecto';
	$text['alignr'] = 'Derecho';
	$text['alignl'] = 'Izquierda';
	$text['alignc'] = 'Centro';
	$text['bullets'] = 'Mostrar viñetas en las listas';
	$text['pos'] = 'Mostrar Juegos Posición';
	$text['img'] = 'Juegos de mostrar imágenes';
	$text['imgtype'] = 'Tipo de imágenes:';
	$text['imgtypes'] = 'Pequeño (60x40)';
	$text['imgtyped'] = 'Defecto (80x80)';
	$text['imgtypef'] = 'Feature (175x50)';
	$text['imgtypesf'] = 'Subfeature (175x50)';
	$text['showt'] = 'Mostrar Juegos texto';
	$text['titlepos'] = 'Título de la posición:';
	$text['titleposti'] = 'Título sobre la imagen';
	$text['titleposit'] = 'Imagen sobre la título';
	$text['bfglogin'] = 'Su <a href="http://affiliates.bigfishgames.com/index.html?afcode=af6e89e0ae1a">BigFishGames afiliados</a> de inicio de sesión:';
	$text['bfgloginnb'] = 'Puede dejar este campo vacío, <br/> flash puede trabajar sin conexión, <br/> o el uso de conexión adecuados.';
	$text['bfgchan'] = 'Afiliado BigFishGames canal de cliente:';
	$text['bfgchannb'] = 'Nombre de dominio se utiliza por defecto. <br/> Deje este campo vacío, a no utilizar los canales. <br/> Por favor, use alfa numéricos.';
	$text['copy'] = 'Copyright 2008-2011 por <a href="http://www.chocosnow.es/">ChocoSnow.es</a>';

	$options = $newoptions = get_option ('widget_mrsnow_bfgtopgames_ES');
	...
	$options['lang'] = $options['lang'] ? $options['lang'] : 'es';
...
function widget_mrsnow_bfgtopgames_ES_init () 
{	
	...
	function widget_mrsnow_bfgtopgames_ES ($args) 
	{
		extract ($args);
		//$start = mrsnow_microtime_float ();
		//echo $before_widget;
		echo "\n".'<!-- Widget Top BFG Games ES: START -->'."\n";
		echo widget_mrsnow_bfgtopgames_ES_work ($before_title, $after_title);
		echo "\n".'<!-- Widget Top BFG Games ES: END -->'."\n";
		//echo $after_widget;
	...
	register_sidebar_widget (array ('Widget Top BFG Games ES', 'widgets'), 'widget_mrsnow_bfgtopgames_ES');
	register_widget_control (array ('Widget Top BFG Games ES', 'widgets'), 'widget_mrsnow_bfgtopgames_ES_control');
};

// Delay plugin execution to ensure Dynamic Sidebar has a chance to load first
add_action ('widgets_init', 'widget_mrsnow_bfgtopgames_ES_init');
